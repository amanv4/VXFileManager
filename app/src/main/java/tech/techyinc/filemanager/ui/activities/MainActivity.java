...
import static tech.techyinc.filemanager.file_operations.filesystem.FolderStateKt.WRITABLE_OR_ON_SDCARD;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.COMPRESS;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.COPY;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.DELETE;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.EXTRACT;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.MOVE;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.NEW_FILE;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.NEW_FOLDER;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.RENAME;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.SAVE_FILE;
import static tech.techyinc.filemanager.file_operations.filesystem.OperationTypeKt.UNDEFINED;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_ADDRESS;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_DEFAULT_PATH;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_EDIT;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_HAS_PASSWORD;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_KEYPAIR_NAME;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_NAME;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_PASSWORD;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_PORT;
import static tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.ARG_USERNAME;
import static tech.techyinc.filemanager.ui.fragments.FtpServerFragment.REQUEST_CODE_SAF_FTP;
import static tech.techyinc.filemanager.ui.fragments.preference_fragments.PreferencesConstants.PREFERENCE_BOOKMARKS_ADDED;
import static tech.techyinc.filemanager.ui.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORED_NAVIGATION;
import static tech.techyinc.filemanager.ui.fragments.preference_fragments.PreferencesConstants.PREFERENCE_NEED_TO_SET_HOME;
import static tech.techyinc.filemanager.ui.fragments.preference_fragments.PreferencesConstants.PREFERENCE_VIEW;
...
import tech.techyinc.filemanager.TagsHelper;
import tech.techyinc.filemanager.adapters.data.StorageDirectoryParcelable;
import tech.techyinc.filemanager.application.AppConfig;
import tech.techyinc.filemanager.asynchronous.SaveOnDataUtilsChange;
import tech.techyinc.filemanager.asynchronous.asynctasks.CloudLoaderAsyncTask;
import tech.techyinc.filemanager.asynchronous.asynctasks.DeleteTask;
import tech.techyinc.filemanager.asynchronous.asynctasks.MoveFiles;
import tech.techyinc.filemanager.asynchronous.management.ServiceWatcherUtil;
import tech.techyinc.filemanager.asynchronous.services.CopyService;
import tech.techyinc.filemanager.database.CloudContract;
import tech.techyinc.filemanager.database.CloudHandler;
import tech.techyinc.filemanager.database.SortHandler;
import tech.techyinc.filemanager.database.TabHandler;
...
import tech.techyinc.filemanager.file_operations.exceptions.CloudPluginException;
import tech.techyinc.filemanager.file_operations.filesystem.OpenMode;
import tech.techyinc.filemanager.file_operations.filesystem.StorageNaming;
import tech.techyinc.filemanager.file_operations.filesystem.usb.SingletonUsbOtg;
import tech.techyinc.filemanager.file_operations.filesystem.usb.UsbOtgRepresentation;
import tech.techyinc.filemanager.filesystem.ExternalSdCardOperation;
...
import tech.techyinc.filemanager.filesystem.MakeFileOperation;
import tech.techyinc.filemanager.filesystem.PasteHelper;
import tech.techyinc.filemanager.filesystem.RootHelper;
import tech.techyinc.filemanager.filesystem.files.FileUtils;
import tech.techyinc.filemanager.filesystem.ssh.SshConnectionPool;
import tech.techyinc.filemanager.ui.activities.superclasses.PermissionsActivity;
import tech.techyinc.filemanager.ui.dialogs.GeneralDialogCreation;
import tech.techyinc.filemanager.ui.dialogs.RenameBookmark;
import tech.techyinc.filemanager.ui.dialogs.RenameBookmark.BookmarkCallback;
import tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog;
import tech.techyinc.filemanager.ui.dialogs.SmbConnectDialog;
import tech.techyinc.filemanager.ui.dialogs.SmbConnectDialog.SmbConnectionListener;
import tech.techyinc.filemanager.ui.drag.TabFragmentBottomDragListener;
import tech.techyinc.filemanager.ui.fragments.AppsListFragment;
import tech.techyinc.filemanager.ui.fragments.CloudSheetFragment;
import tech.techyinc.filemanager.ui.fragments.CloudSheetFragment.CloudConnectionCallbacks;
import tech.techyinc.filemanager.ui.fragments.CompressedExplorerFragment;
import tech.techyinc.filemanager.ui.fragments.FtpServerFragment;
import tech.techyinc.filemanager.ui.fragments.MainFragment;
import tech.techyinc.filemanager.ui.fragments.ProcessViewerFragment;
import tech.techyinc.filemanager.ui.fragments.SearchWorkerFragment;
import tech.techyinc.filemanager.ui.fragments.TabFragment;
import tech.techyinc.filemanager.ui.fragments.preference_fragments.PreferencesConstants;
import tech.techyinc.filemanager.ui.strings.StorageNamingHelper;
import tech.techyinc.filemanager.ui.views.appbar.AppBar;
import tech.techyinc.filemanager.ui.views.drawer.Drawer;
import tech.techyinc.filemanager.utils.AppConstants;
import tech.techyinc.filemanager.utils.BookSorter;
import tech.techyinc.filemanager.utils.DataUtils;
import tech.techyinc.filemanager.utils.MainActivityHelper;
import tech.techyinc.filemanager.utils.OTGUtil;
...
public class MainActivity extends PermissionsActivity
  ...
  public static final String CLOUD_AUTHENTICATOR_REDIRECT_URI = "tech.techyinc.filemanager:/auth";
  ...
  private static final String INTENT_ACTION_OPEN_QUICK_ACCESS =
      "tech.techyinc.filemanager.openQuickAccess";
  private static final String INTENT_ACTION_OPEN_RECENT = "tech.techyinc.filemanager.openRecent";
  private static final String INTENT_ACTION_OPEN_FTP_SERVER = "tech.techyinc.filemanager.openFTPServer";
  private static final String INTENT_ACTION_OPEN_APP_MANAGER =
      "tech.techyinc.filemanager.openAppManager";
