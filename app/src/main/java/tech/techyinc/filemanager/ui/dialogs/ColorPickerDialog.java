...
import tech.techyinc.filemanager.ui.views.CircularColorsView;
    ...
    if (selectedIndex == NO_DATA) { // if instance was restored the value is already set
      boolean isUsingDefault =
          sharedPrefs.getInt(PreferencesConstants.PREFERENCE_COLOR_CONFIG, NO_DATA) == NO_DATA
              && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_orange)
                  == R.color.primary_orange
              && sharedPrefs.getInt(
                      PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_orange)
                  == R.color.primary_orange
              && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_ACCENT, R.color.primary_deep_orange)
                  == R.color.primary_deep_orange
              && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_ICON_SKIN, R.color.primary_amber)
