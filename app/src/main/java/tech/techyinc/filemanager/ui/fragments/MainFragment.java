...
package tech.techyinc.filemanager.ui.fragments;

import static android.os.Build.VERSION_CODES.JELLY_BEAN;
import static tech.techyinc.filemanager.filesystem.ssh.SshConnectionPool.SSH_URI_PREFIX;
...
import tech.techyinc.filemanager.adapters.data.LayoutElementParcelable;
...
import tech.techyinc.filemanager.asynchronous.asynctasks.LoadFilesListTask;
import tech.techyinc.filemanager.asynchronous.handlers.FileHandler;
...
import tech.techyinc.filemanager.file_operations.filesystem.smbstreamer.Streamer;
import tech.techyinc.filemanager.filesystem.CustomFileObserver;
import tech.techyinc.filemanager.filesystem.FileProperties;
...
import tech.techyinc.filemanager.filesystem.cloud.CloudUtil;
import tech.techyinc.filemanager.filesystem.files.CryptUtil;
import tech.techyinc.filemanager.filesystem.files.EncryptDecryptUtils;
import tech.techyinc.filemanager.filesystem.files.FileListSorter;
import tech.techyinc.filemanager.filesystem.files.FileUtils;
import tech.techyinc.filemanager.filesystem.ssh.SshClientUtils;
...
import tech.techyinc.filemanager.ui.drag.RecyclerAdapterDragListener;
import tech.techyinc.filemanager.ui.drag.TabFragmentBottomDragListener;
import tech.techyinc.filemanager.ui.fragments.data.MainFragmentViewModel;
import tech.techyinc.filemanager.ui.icons.MimeTypes;
import tech.techyinc.filemanager.ui.provider.UtilitiesProvider;
import tech.techyinc.filemanager.ui.theme.AppTheme;
import tech.techyinc.filemanager.ui.views.CustomScrollGridLayoutManager;
import tech.techyinc.filemanager.ui.views.CustomScrollLinearLayoutManager;
import tech.techyinc.filemanager.ui.views.DividerItemDecoration;
import tech.techyinc.filemanager.ui.views.FastScroller;
import tech.techyinc.filemanager.ui.views.WarnableTextInputValidator;
import tech.techyinc.filemanager.utils.BottomBarButtonPath;
...
public class MainFragment extends Fragment
  ...
  public void adsLoader(){
    ...
    hasInternetConnection().subscribe((hasInternet) -> {
      if (hasInternet) {
        final LinearLayout banner = (LinearLayout) rootView.findViewById(R.id.banner_setting);
        banner.setVisibility(View.VISIBLE);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
      } else {
        final SwipeRefreshLayout mar = (SwipeRefreshLayout) rootView.findViewById(R.id.activity_main_swipe_refresh_layout);
