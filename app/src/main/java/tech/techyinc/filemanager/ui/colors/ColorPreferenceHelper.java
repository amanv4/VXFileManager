...
package tech.techyinc.filemanager.ui.colors;
...
public class ColorPreferenceHelper {
  ...
  public static final @ColorRes int DEFAULT_PRIMARY_FIRST_TAB = R.color.primary_orange,
      DEFAULT_PRIMARY_SECOND_TAB = R.color.primary_orange,
      DEFAULT_ACCENT = R.color.primary_deep_orange,
      DEFAULT_ICON_SKIN = R.color.primary_amber;
  ...
  private boolean isUsingOldColorsSystem(SharedPreferences prefs) {
    int tabOne = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_orange);
    int tabTwo = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_orange);
    int accent = prefs.getInt(PreferencesConstants.PREFERENCE_ACCENT, R.color.primary_deep_orange);
    int iconSkin = prefs.getInt(PreferencesConstants.PREFERENCE_ICON_SKIN, R.color.primary_amber);
  ...
  private @ColorInt int correctForIndex(Context c, int color) {
    ...
    else return Utils.getColor(c, R.color.primary_orange);
  }
}
