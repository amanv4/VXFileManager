...
package tech.techyinc.filemanager.ui.fragments.preference_fragments
...
import tech.techyinc.filemanager.adapters.ColorAdapter
import tech.techyinc.filemanager.application.AppConfig
import tech.techyinc.filemanager.databinding.DialogGridBinding
import tech.techyinc.filemanager.ui.activities.PreferencesActivity
import tech.techyinc.filemanager.ui.colors.ColorPreference
import tech.techyinc.filemanager.ui.colors.UserColorPreferences
import tech.techyinc.filemanager.ui.dialogs.ColorPickerDialog
import tech.techyinc.filemanager.ui.views.preference.InvalidablePreferenceCategory
import tech.techyinc.filemanager.ui.views.preference.SelectedColorsPreference
...
class ColorPref : PreferenceFragmentCompat(), Preference.OnPreferenceClickListener {
    ...
    private fun colorChangeDialog(colorPrefKey: String) {
        ...
        if (userColorPreferences != null) {
            ...
            dialog = MaterialDialog.Builder(activity)
                .positiveText(tech.techyinc.filemanager.R.string.cancel)
                .title(tech.techyinc.filemanager.R.string.choose_color)
                .theme(activity.appTheme.materialDialogTheme)
                .autoDismiss(true)
                .positiveColor(fab_skin)
                .neutralColor(fab_skin)
                .neutralText(tech.techyinc.filemanager.R.string.default_string)
                .onNeutral { _, _ ->
    ...
    private fun loadSection0() {
        ...
        addPreferencesFromResource(tech.techyinc.filemanager.R.xml.color_prefs)
    ...
    private fun loadSection1() {
        addPreferencesFromResource(tech.techyinc.filemanager.R.xml.conficolor_prefs)
    ...
    private fun createColorPickerDialogListener() = ColorPickerDialog.OnAcceptedConfig {
        ...
        sharedPref!!.getInt(
            ...
            if (colorPickerPref == ColorPickerDialog.RANDOM_INDEX) {
                AppConfig.toast(getActivity(), tech.techyinc.filemanager.R.string.set_random)
            }
        }
    }
