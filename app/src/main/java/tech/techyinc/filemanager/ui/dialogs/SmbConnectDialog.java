...
import static tech.techyinc.filemanager.utils.SmbUtil.PARAM_DISABLE_IPC_SIGNING_CHECK;
...
import tech.techyinc.filemanager.filesystem.smb.CifsContexts;
import tech.techyinc.filemanager.ui.ExtensionsKt;
...
import tech.techyinc.filemanager.utils.EditTextColorStateUtil;
...
public class SmbConnectDialog extends DialogFragment {
  ...
  public interface SmbConnectionListener {
     ...
     *     now. See {@link tech.techyinc.filemanager.database.UtilsHandler#removeSmbPath(String,
     *     String)}
     */
