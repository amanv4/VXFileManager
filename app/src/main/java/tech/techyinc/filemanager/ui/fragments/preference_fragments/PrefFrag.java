...
import static tech.techyinc.filemanager.R.string.feedback;
import static tech.techyinc.filemanager.ui.activities.PreferencesActivity.START_PREFERENCE;
import static tech.techyinc.filemanager.utils.Utils.EMAIL_SUPPORT;
...
import tech.techyinc.filemanager.ui.activities.AboutActivity;
...
import tech.techyinc.filemanager.ui.views.preference.CheckBox;
...
public class PrefFrag extends PreferenceFragmentCompat
  ...
  public static final String URL_PRIVACY_POLICY = "https://www.techyinc.tech/vx-file-manager-privacy-policy";
  ...
  private static final String[] PREFERENCE_KEYS = {
    ...
    PreferencesConstants.FRAGMENT_POLICY,
      ...
      case PreferencesConstants.FRAGMENT_FEEDBACK:
        ...
        if (isIntentSafe)
          ...
          Toast.makeText(
              ...
              .show();
        return false;
      case PreferencesConstants.FRAGMENT_POLICY:
