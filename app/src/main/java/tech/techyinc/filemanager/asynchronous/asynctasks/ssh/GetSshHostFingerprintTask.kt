...
package tech.techyinc.filemanager.asynchronous.asynctasks.ssh
...
import tech.techyinc.filemanager.filesystem.ssh.CustomSshJConfig
...
import tech.techyinc.filemanager.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT
 ...
 *
 *
 * Mainly used by [tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog] on saving SSH
 * connection settings.
 *
 * @see HostKeyVerifier
 *
 * @see SSHClient.addHostKeyVerifier
 * @see tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.onCreateDialog
 */
