...
package tech.techyinc.filemanager.asynchronous.services.ftp
...
import tech.techyinc.filemanager.filesystem.ftpserver.AndroidFileSystemFactory
...
class FtpService : Service(), Runnable {
    ...
    companion object {
        ...
        const val ACTION_START_FTPSERVER =
            "tech.techyinc.filemanager.services.ftpservice.FTPReceiver.ACTION_START_FTPSERVER"
        const val ACTION_STOP_FTPSERVER =
            "tech.techyinc.filemanager.services.ftpservice.FTPReceiver.ACTION_STOP_FTPSERVER"
