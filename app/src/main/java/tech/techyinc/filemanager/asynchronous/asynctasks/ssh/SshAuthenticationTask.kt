 ...
 *
 *
 * Used by [tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog].
 *
 * @see SSHClient
 *
 * @see SSHClient.authPassword
 * @see SSHClient.authPublickey
 * @see tech.techyinc.filemanager.ui.dialogs.SftpConnectDialog.authenticateAndSaveSetup
 * @see tech.techyinc.filemanager.filesystem.ssh.SshConnectionPool.create
 */
