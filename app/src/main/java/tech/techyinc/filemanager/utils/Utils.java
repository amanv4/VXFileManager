...
public class Utils {
  ...
  private static final String EMAIL_AMAN = "aman3sbhadoria@gmail.com";
  private static final String URL_TELEGRAM = "https://t.me/VXFileManager";

  public static final String EMAIL_NOREPLY_REPORTS = "no-reply@techyinc.tech";
  public static final String EMAIL_SUPPORT = "support@techyinc.tech";
  ...
  public static Intent buildEmailIntent(String text, String supportMail) {
    ...
    String[] aEmailCCList = {EMAIL_AMAN};
    emailIntent.putExtra(Intent.EXTRA_EMAIL, aEmailList);
    emailIntent.putExtra(Intent.EXTRA_CC, aEmailCCList);
    emailIntent.putExtra(
        Intent.EXTRA_SUBJECT, "Feedback : VX File Manager for " + BuildConfig.VERSION_NAME);
