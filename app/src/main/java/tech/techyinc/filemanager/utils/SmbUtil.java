...
public class SmbUtil {
   ...
   *
   * @param path SMB path
   * @return {@link tech.techyinc.filemanager.filesystem.FolderStateKt#DOESNT_EXIST} if specified SMB
   *     path doesn't exist on server, else {@link
   *     tech.techyinc.filemanager.filesystem.FolderStateKt#WRITABLE_ON_REMOTE}
   */
