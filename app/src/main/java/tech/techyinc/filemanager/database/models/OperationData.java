...
package tech.techyinc.filemanager.database.models;

import static tech.techyinc.filemanager.database.UtilsHandler.Operation.BOOKMARKS;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.GRID;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.HIDDEN;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.HISTORY;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.LIST;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.SFTP;
import static tech.techyinc.filemanager.database.UtilsHandler.Operation.SMB;

import tech.techyinc.filemanager.database.UtilsHandler;
import tech.techyinc.filemanager.database.UtilsHandler.Operation;
